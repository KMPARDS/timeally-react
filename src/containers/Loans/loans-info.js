          ...
          <div className="container dashboard-bg">
            <div className="row">
              <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <h2 className="align-left">About TimeAlly Loan</h2>
              <p className="avail-btm-border">All TimeAlly Stake holders will get the opportunity to avail TimeAlly loan which they have to
repay back within 30 Day 10 Hours or before the end of ES NRT Month. There will be an
interest of 0.1% per day on the loan amount. If the staker fails to repay back the TimeAlly
Loan Principle amount and interest, then the stakes of the staker will be burnt. The amount
of Loan, for which an individual staker is eligible, depends on his IssTime Limit, however, it
cannot be more than 97% of the current staking.</p>
